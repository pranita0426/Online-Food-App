...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    // content management
    { icon: Package, label: 'Products', path: '/admin/products', color: 'from-pink-400 to-rose-400' },
    { icon: Sparkles, label: 'Restaurants', path: '/admin/restaurants', color: 'from-yellow-400 to-orange-400' },
    // other sections
