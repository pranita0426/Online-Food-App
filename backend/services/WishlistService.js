...
const mongoose  = require  ("mongoose");
 ...
 const addToWishlist = async (userId, productId) => {
  // if product id looks like a Mongo ObjectId, try to verify it exists in the
  // products collection.  Otherwise assume it's coming from our dummy/local
  // menuData and allow it through.  This prevents a 400 when using numeric
  // ids in frontend prototyping.
